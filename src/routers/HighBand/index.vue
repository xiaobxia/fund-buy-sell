<template>
  <div class="operating-info">
    <mt-header title="高风偏波段" :fixed="true">
    ...
    <div class="main-body">
      ...
      'should-' + getShouldDo(item.detail.kline, item.detail.buySellHigh)
      ]">
        <div slot="title">
          <h3>
          ...
          <p class="explain">
            <span v-for="(subItem, index) in item.detail.buySellHigh" :key="subItem + index"
