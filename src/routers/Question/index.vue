<template>
  <div class="page-question">
    <mt-header title="常见问题" :fixed="true">
    ...
    <div class="main-body">
      <fold-card>
        <div slot="title">1.什么时候开始出信号？</div>
      ...
      <fold-card>
        ...
        <div slot="content">
          ...
          <p class="l-2">订的越久，每个交易日的单价就越便宜。以套餐一为例，总价是120元，可以用60个交易日，折合每个交易日是2元。60个交易日可以用多久呢？一个月平均是21个交易日，60个交易日相当于3个月，也就是说120元可以用3个月。那贵吗？帮大家算一笔账，假如您持有1支基金1万元，它一天跌了1.2%，那也就是说您亏了120元。但是如果您使用系统后提前躲过了下跌，只要躲过1次，您就能少亏120元，收回成本了。</p>
        </div>
      </fold-card>
      <fold-card>
      ...
      <fold-card>
        <div slot="title">6.怎么降低买卖时的费率？</div>
        <div slot="content">
...
import FoldCard from '../../markComponents/FoldCard/index.vue'
export default {
  name: 'Question',
  components: {FoldCard},
  data () {
